...
class Derm7PtDataset(object):
    ...
    # Vascular Structures: Fabbrocini2014 - Automatic Diagnosis of Melanoma Based on the 7-Point Checklist
    # Blue Whitish Veil: Madooei2013 - Automatic Detection of Blue-White Veil by Discrete Colour Matching in Dermoscopy Images
    # Pigmentation: Fabbrocini2014 - Automatic Diagnosis of Melanoma Based on the 7-Point Checklist
    # Streaks: Mirzaalian2012 - Learning features for streak detection in dermoscopic color images using localized radial flux of principal intensity curvature
    # Dots and Globules: Fabbrocini2014 - Automatic Diagnosis of Melanoma Based on the 7-Point Checklist
    # Regression Structures: Fabbrocini2014 - Automatic Diagnosis of Melanoma Based on the 7-Point Checklist
